...
<html>
 ...
 <table style="width:100%;">
  <tr>
   <th colspan="2">Movies <a href="movie_copy.php?action=add">[ADD]</a></th>
  </tr>
<?php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo $row['movie_name'];
    echo '</td><td>';
    echo ' <a href="movie_copy.php?action=edit&id=' . $row['movie_id'] . '"> [EDIT]</a>'; 
    echo ' <a href="delete_copy.php?type=movie&id=' . $row['movie_id'] . '"> [DELETE]</a>';
    echo '</td></tr>';
}
?>
  <tr>
