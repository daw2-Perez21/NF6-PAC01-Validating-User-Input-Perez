...
case 'add':
    ...
    case 'movie':
        ...
        if (empty($error)) {
          ...
          header('Location:movie_copy.php?action=add' .
...
case 'edit':
    ...
    case 'movie':
        ...
        if (empty($error)) {
          ...
          header('Location:movie_copy.php?action=edit&id=' . $_POST['movie_id'] .
              '&error=' . join($error, urlencode('<br/>')));
        }
        break;
    }
...
case 'add':
    ...
    case 'people':
        $error = array();
        $people_name = isset($_POST['people_fullname']) ?
            trim($_POST['people_fullname']) : '';
        if (empty($people_name)) {
            $error[] = urlencode('Please enter a actor name.');
        }
        if (empty($error)) {
        $query = 'INSERT INTO
            people
          ...
          header('Location:people_copy.php?action=add&id=' . $_POST['people_id'] .
              '&error=' . join($error, urlencode('<br/>')));
        }
        break;
    }
...
case 'edit':
    ...
    case 'people':
        ...
        $query = 'UPDATE people SET
          ...
          header('Location:people_copy.php?action=edit&id=' . $_POST['people_id'] .
              '&error=' . join($error, urlencode('<br/>')));
        }
        break;
    }
...
?>
  <p>Done!</p>
  <a href="admin_copy.php">Return to Index</a></p>
 </body>
</html>
